...
jq '.channel_group.groups.Application.groups."user-auth-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.233.129","port": 7003}]},"version": "0"}}' authchannel_current_config.json > authchannel_modified_anchor_config.json
